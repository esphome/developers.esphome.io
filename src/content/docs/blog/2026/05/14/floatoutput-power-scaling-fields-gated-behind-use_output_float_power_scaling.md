---
title: "FloatOutput Power Scaling Fields Gated Behind USE_OUTPUT_FLOAT_POWER_SCALING"
date: 2026-05-14
authors: bdraco
---
...
1. You do **not** use the `output.set_min_power` or `output.set_max_power` automation actions anywhere, **and**
1. You **do** call `id(...).set_min_power(...)`, `id(...).set_max_power(...)`, or `id(...).set_zero_means_zero(...)` directly from a `lambda:`.
...
1. If you cannot rely on user YAML, declare the define in your component's Python codegen:
