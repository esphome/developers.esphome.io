---
title: "call_loop(), mark_failed(), and call_dump_config() Are No Longer Virtual"
date: 2026-03-12
authors: bdraco
---
...
1. **`ESP32BLE::mark_failed()`** — removed in [#4173](https://github.com/esphome/esphome/pull/4173) (Jan 2023) when BLE was refactored to use event handlers
1. **`MQTTComponent::call_dump_config()`** — removed in [#14355](https://github.com/esphome/esphome/pull/14355); the override incorrectly skipped `dump_config()` for internal entities
