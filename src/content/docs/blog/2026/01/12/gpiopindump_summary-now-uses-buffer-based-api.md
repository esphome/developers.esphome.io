---
title: "GPIOPin::dump_summary() Now Uses Buffer-Based API"
date: 2026-01-12
authors: bdraco
---
...
1. **Parameters**: Takes `char *buffer` and `size_t len`
1. **Writing**: Use `snprintf()` directly to the provided buffer
1. **No allocation**: No `std::string` construction needed
