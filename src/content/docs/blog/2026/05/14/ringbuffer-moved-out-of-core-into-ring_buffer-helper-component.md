---
title: "RingBuffer Moved Out of Core Into ring_buffer Helper Component"
date: 2026-05-14
authors: bdraco
---
...
1. Update the namespace at every callsite:
...
1. Add `AUTO_LOAD` in your component's `__init__.py`:
