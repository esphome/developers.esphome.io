---
title: "Network get_use_address() Optimization"
date: 2025-11-20
authors: bdraco
---
...
1. **Extra memory usage** - The `std::string` object itself uses heap memory plus object overhead (typically 24-32 bytes)
1. **API complexity** - Callers needed to use `.c_str()` to access the raw address for logging, even though no conversion or copy was performed
