---
title: "ESP32 Arduino Selective Compilation: Libraries Disabled by Default"
date: 2026-02-12
authors: bdraco
---
...
1. Enables any Arduino library dependencies (e.g., `WiFi` depends on `Network`)
1. Un-stubs any IDF managed components that the library requires
