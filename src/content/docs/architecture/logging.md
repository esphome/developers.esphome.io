...
1. **Memory allocation** - For the formatted message
1. **Serial output** - Written to the console/UART
1. **Network packet creation** - The log message is packaged for transmission
1. **Network transmission** - Sent over WiFi/Ethernet to connected clients
...
1. **Group related fields** that are always logged together:
...
1. **Keep optional fields separate**:
