---
title: "Interfacing via SPI"
---

We have an [example, minimal SPI-based component](https://github.com/esphome/starter-components/tree/main/components/empty_spi_component).
