---
title: "Default-Constructed PollingComponent No Longer Polls"
date: 2026-05-14
authors: bdraco
---
...
1. Construct the instance via the no-argument `PollingComponent()` constructor (not `PollingComponent(interval)`)
1. Never call `set_update_interval()` afterwards
...
> [!WARNING]
> **Don't call `set_update_interval()` from inside `setup()`**
>
