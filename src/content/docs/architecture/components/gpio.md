---
title: "Interfacing via GPIO"
---

We have an [example, minimal component which uses a single GPIO pin](https://github.com/esphome/starter-components/tree/main/components/empty_gpio_component).
