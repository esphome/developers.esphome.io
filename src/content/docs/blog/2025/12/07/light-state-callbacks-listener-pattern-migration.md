---
title: "Light State Callbacks: Listener Pattern Migration"
date: 2025-12-07
authors: bdraco
---
...
1. **Always allocated** - Callback storage was allocated regardless of whether callbacks were registered
1. **Indirect calls** - `std::function` adds indirection overhead for every callback invocation
