...
Once you have [set up your development environment](/contributing/development-environment), committed to and pushed your branch,
...
- **Follow all [codebase standards](/contributing/code#codebase-standards).** When reviewers have to spend time pointing out
...
- Are all [codebase standards](/contributing/code#codebase-standards) adhered to?
...
For this reason, you'll periodically want to update your local `dev` branch. A more detailed explanation can be found in
[Home Assistant's developer documentation](https://developers.home-assistant.io/docs/en/development_catching_up.html), but here's the TL;DR:
