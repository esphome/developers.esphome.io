---
title: "Icon and Device Class Getter Migration"
date: 2026-03-12
authors: bdraco
---
...
- `set_internal()` (supported again during setup since 2026.10.0, see [this post](/blog/2026/09/10/set_internal-supported-during-setup/))
